...
public class SwagTests extends TestActions {
    ...
    public void allTestCases() throws InterruptedException {
            ...
            SwagLabsLogin swagLabsLoginElement = new SwagLabsLogin(driver.get());
            ...
            SwagLabsInventory swagLabsInventoryElement = new SwagLabsInventory(driver.get());
            ...
            SwagLabsCart swagLabsCartElement = new SwagLabsCart(driver.get());
            ...
            SwagLabsChekoutUserInfo swagLabsChekoutUserInfoElement = new SwagLabsChekoutUserInfo(driver.get());
            ...
            SwagLabsCheckout swagLabsChekoutElement = new SwagLabsCheckout(driver.get());
